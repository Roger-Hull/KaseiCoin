...
contract KaseiCoinCrowdsale is Crowdsale, MintedCrowdsale{ 
    // Provide parameters for all of the features of your crowdsale(rate, wallet, and token)
    ...
    constructor(
        ...
        // Crowdsale constructor can stay empty
    }
}
...
contract KaseiCoinCrowdsaleDeployer {
    ...
    constructor(
       ...
       address payable wallet
        ...
        kasei_crowdsale_address = address(token); // maybe change the variable to "token"
